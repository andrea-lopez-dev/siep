...
switch ($_GET["op"]) {
	...
	if (empty($idpersona)) {
		$rspta=$persona->insertar($tipo_persona,$nombre,$clavehash,$tipo_documento,$num_documento,$direccion,$telefono,$email);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	} else{
         $rspta=$persona->editar($idpersona,$tipo_persona,$nombre,$clavehash,$tipo_documento,$num_documento,$direccion,$telefono,$email);
